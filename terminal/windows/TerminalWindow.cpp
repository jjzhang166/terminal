...
bool TerminalWindow::RegistSuccess() {
	...
	//检查cpu序列号
	Util::GenerateMach(localRegistCod, 1);
	localRegistCod[4] = '-';
	//检查硬盘序列号
	Util::GenerateMach(localRegistCod, 2);
	localRegistCod[9] = '-';

	Util::GenerateMach(localRegistCod, 3);
...
//void TerminalWindow::Update_KeyPairs() {
